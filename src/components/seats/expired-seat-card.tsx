...
export function ExpiredSeatCard({ seat, onClick }: ExpiredSeatCardProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full rounded-xl border border-[var(--slate-200)] bg-[var(--slate-50)] p-4 text-left shadow-sm hover:shadow-md hover:border-[var(--slate-300)] transition-all cursor-pointer min-h-[120px] opacity-60"
    >
